...
![Превью HA Shutter Card](preview.png) ![Превью HA Shutter Card](preview1.png) ![Превью HA Shutter Card](preview2.png)
...
- 🎯 **Детализированная шторка** — 24 планки с плавной анимацией открытия/закрытия
